...
cp jobs/params_large_standard.txt "$RESULTS_DIR/" 2>/dev/null || echo "  Warning: params_large_standard.txt not found"
cp jobs/large_standard_jobs.submit "$RESULTS_DIR/standard_jobs.submit" 2>/dev/null || echo "  Warning: large_standard_jobs.submit not found"
