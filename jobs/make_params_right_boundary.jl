...
"""
Generate parameter file for Right Boundary Scan
Explores measurement-induced phase transition with Rényi-2 Binder
...
# Open output file
open("params_right_boundary.txt", "w") do f
    seed = seed_start
...
println("Parameter file generated: params_right_boundary.txt")
