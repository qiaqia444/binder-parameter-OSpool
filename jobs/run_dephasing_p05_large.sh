...
# Wrapper script for HTCondor: Large Dephasing P=0.5 simulation (L=20-36)
# This runs the Julia simulation with dephasing channels for large systems
...
echo "========================================"
echo "Large Dephasing P=0.5 Simulation Starting"
echo "========================================"
...
echo "========================================"
echo "Large system simulation completed with exit code: $exit_code"
echo "========================================"
