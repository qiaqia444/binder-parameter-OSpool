...
"""
Generate parameter file for Learning-to-Trivial Transition Scan (λ_x = 0.63, λ_zz = 0.07)
Explores the phase transition from learning to trivial phase with Rényi-2 Binder
...
# Open output file
open("params_learning_to_trivial_lambda0.9.txt", "w") do f
    seed = seed_start
    ...
    for L in L_values
        for P in P_values
            for sample in 1:n_samples
                ...
                out_prefix = @sprintf("learning_to_trivial_lambda0.9_L%d_lx%.2f_lzz%.2f_Px%.2f_s%d", 
...
println("Parameter file generated: params_learning_to_trivial_lambda0.9.txt")
