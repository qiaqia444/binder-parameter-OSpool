...
# Run simulation
echo "Running standard simulation..."
...
julia --project=. run.jl --L $L --lambda_x $lambda_x --lambda_zz $lambda_zz --lambda $lambda --ntrials $ntrials --seed $seed --sample $sample --out_prefix $out_prefix --outdir output
EXIT_CODE=$?
