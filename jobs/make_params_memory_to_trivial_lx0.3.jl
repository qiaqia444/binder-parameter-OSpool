...
"""
Generate parameter file for Memory-to-Trivial Transition Scan (λ_x = 0.3)
Explores the phase transition from memory-keeping to trivial phase

Scans: P_x = P_zz from 0 to 0.5 (coupled dephasing)
Fixed: λ_x = 0.3 (X measurements), λ_zz = 0.7 (ZZ measurements)
"""
...
lambda_x = 0.3   # X measurement strength
...
# Open output file
open("params_memory_to_trivial_lx0.3.txt", "w") do f
    seed = seed_start
...
println("Parameter file generated: params_memory_to_trivial_lx0.3.txt")
