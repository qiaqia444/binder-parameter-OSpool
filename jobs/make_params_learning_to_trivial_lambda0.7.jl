...
"""
Generate parameter file for Learning-to-Trivial Transition Scan (λ_x = 0.49, λ_zz = 0.21)
...
Fixed: λ_x = 0.49 (X measurements), λ_zz = 0.21 (ZZ measurements)
"""
...
lambda_zz = 0.21  # ZZ measurement strength
...
# Open output file
open("params_learning_to_trivial_lambda0.7.txt", "w") do f
    seed = seed_start
    ...
    for L in L_values
        for P in P_values
            for sample in 1:n_samples
                ...
                out_prefix = @sprintf("learning_to_trivial_lambda0.7_L%d_lx%.2f_lzz%.2f_Px%.2f_s%d", 
...
println("Parameter file generated: params_learning_to_trivial_lambda0.7.txt")
