...
"""
Dephasing channel simulation with P = 0.5
...
function main()
    ...
    # P_zz hardcoded to 0.5 to match P_x
    P_zz = 0.5
    
    println("="^70)
    println("Dephasing Channel Simulation (P = 0.5)")
    println("="^70)
    ...
    output_data = Dict(
        ...
        "seed" => seed_val,
        "sample" => sample,
        "measurement_type" => "dephasing_channel_p05"
    )
